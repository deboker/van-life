...
// Run Mirage only in development
if (import.meta.env.DEV) {
    createServer({
        ...
        seeds(server) {
            ...
            server.create("user", { id: "12345", email: "vans@vans.com", password: "vans12345", name: "Vans" })
        },
        ...
        routes() {
            ...
            this.passthrough("https://vanlife-a2e86.firebaseapp.com/**")
